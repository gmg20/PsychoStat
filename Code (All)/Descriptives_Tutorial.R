...
describeBy(x = dat1$StudyHrs, group = dat1$Gender) # Descriptives by group level (gender)
...
describeBy(x = dat2$neurot, group = dat2$year) # Descriptives for neuroticism by group level (year)
...
# Study Hours Overall
hist(x = dat1$StudyHrs, main = "Study Hours Histogram")

# Study Hours Overall
p1 <- ggplot(data = dat1, aes(x = StudyHrs)) +
              geom_histogram()
...
p1b <- ggplot(data = dat1, aes(x = StudyHrs, color = Gender, fill = Gender)) +
...
p1c <- ggplot(data = dat1, aes(x = StudyHrs, color = Gender, fill = Gender)) +
              geom_histogram(alpha = 0.3) +
              facet_grid(~Gender)
...
p1d <- ggplot(data = dat2, aes(x = neurot, color = year, fill = year)) +
              geom_histogram(alpha = 0.3)

p1d + ggtitle("Histogram of Neuroticism by School Year")

p1e <- ggplot(data = dat2, aes(x = stress, color = year, fill = year)) +
                geom_histogram(alpha = 0.3)
...
p2 <- ggplot(data = dat1, aes(x = StudyHrs)) +
...
p2b <- ggplot(data = dat1, aes(x = Gender, y = StudyHrs, fill = Gender)) +
...
p2c <- ggplot(data = dat1, aes(x = Gender, y = StudyHrs, fill = Gender)) +
...
p2d <- ggplot(data = dat1, aes(x = StudyHrs, color = Gender, fill = Gender)) +
              geom_density(alpha = 0.3)

p2d + ggtitle("Study Hours by Gender")

p2e <- ggplot(data = dat2, aes(x = neurot, color = year, fill = year)) +
...
# Slightly fancier
p3 <- ggplot(data = dat2, aes(x = stress, y = neurot)) +
              geom_point()
...
p3b <- ggplot(data = dat2, aes(x = stress, y = neurot, color = year)) +
              geom_point()

p3b + ggtitle("Neuroticism by Stress by School Year Scatterplot")

p3c <- ggplot(data = dat2, aes(x = stress, y = neurot, color = year)) +
              geom_point() +
              facet_grid(~year)

p3c + ggtitle("Neuroticism by Stress by School Year Scatterplot")

p3d <- ggplot(data = dat2, aes(x = stress, y = neurot, color = year)) +
              geom_point() +
...
p3e <- ggplot(data = dat2, aes(x = stress, y = neurot, color = year)) +
              geom_point() +
              geom_smooth(method = "lm", se = FALSE) +
              facet_grid(~year)
p3e
...
p6 <- ggplot(data = dat1_summary, aes(x = Gender, y = StudyHrs, colour = Gender))

p6 + geom_errorbar(aes(ymin = StudyHrs - se, ymax = StudyHrs + se), width = .1) + 
                    geom_line() + 
                    geom_point()

p7 <- ggplot(data = dat2_summary, aes(x = year, y = neurot, colour = year))

p7 + geom_errorbar(aes(ymin = neurot - se, ymax = neurot + se), width = .1) + 
                    geom_line() + 
                    geom_point()
